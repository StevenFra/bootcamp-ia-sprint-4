...
from retrieval.indexing_pipeline_utils import get_synopsys_txt,future_version2,future_version3
...
class RetrievalExpsConfig:
    ...
    def __init__(self):
        ...
        self._text_to_embed_fn: Callable = future_version2
        self._text_to_embed_fn: Callable = future_version3
